...
router.register('dates-list', views.DateOrderViewSet, basename='date-list')
router.register('request-photografy', views.RequestPhotografyviewSet, basename='request-photografy')
